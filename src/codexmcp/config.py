...
class Config:
    ...
    def _init(self):
        ...
        # Cache settings
        self.cache_enabled = os.environ.get("CODEXMCP_CACHE_ENABLED", "1").lower() in ("1", "true", "yes")
        ...
        self.default_max_tokens = int(os.environ.get("CODEXMCP_DEFAULT_MAX_TOKENS", "4096"))
    ...
    def _log_config(self):
        ...
        logger.info(f"  Default params: temp={self.default_temperature}, max_tokens={self.default_max_tokens}")
